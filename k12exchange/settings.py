"""
Django settings for k12exchange project.
...
SECRET_KEY = 'jgmm4+5hkeyqg=jovw&hn6wcq**#qw$vh3ztr44q3f&zc(d_v6'
...
ROOT_URLCONF = 'k12exchange.urls'

WSGI_APPLICATION = 'k12exchange.wsgi.application'
